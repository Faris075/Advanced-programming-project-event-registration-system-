 ...
 *
 * OWNER: Faris
 * USED BY: Mohamed Morsy (AdminEventController, EventScheduler)
 *          Mohamed Ehab  (PublicEventController)
 *          Mohamed Ahmed (RegistrationService)
 */
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    /**
     * Counts confirmed registrations for capacity enforcement.
     * Kept here (not in RegistrationRepository) so it's easy to find from EventService.
     *
     * NOTE: Use the fully-qualified enum reference in JPQL — string literals like 'CONFIRMED'
